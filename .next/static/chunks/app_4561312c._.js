...
const mockWishlistProducts = [
    {
        ...
        price: "$71.68",
        images: [
            "/navbar/lookbooks1.webp",
            "/navbar/men_essentials.webp"
        ],
        sizes: [
            "S",
            "M",
...
function WishlistPage() {
    _s();
    const [wishlist, setWishlist] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(mockWishlistProducts);
    const handleWishlistToggle = (id)=>{
        setWishlist((prev)=>prev.filter((p)=>p.id !== id));
    };
    const handleAddToCart = (id, size)=>{
        alert("Added product ".concat(id, " in size ").concat(size, " to cart ✅"));
    };
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(WishlistPage, "FrggYYyn2nl5qhblNPzdTelJVYs=");
_c = WishlistPage;
var _c;
...
//# sourceMappingURL=app_4561312c._.js.map